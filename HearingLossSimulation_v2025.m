...
%%
classdef HearingLossSimulation_v2025 <audioPlugin
properties
    SmearL            = 'Bypass';
    LosstypeL         = 'Bypass';
    LoudGrL           = false;
...
properties (Access = private, Hidden)
 ...
 'PluginName','Hearing Loss Simulation 2025','VendorName','Angeliki Mourgela,Queen Mary University of London & BBC R&D',...
...
audioPluginParameter('TempJitR','Layout',[9,3],...
             'DisplayName','Temporal Disruption','Mapping',{'enum', 'off', 'on'}),...
audioPluginGridLayout('RowHeight',[40,40,40,40,40,40,40,40,40],'ColumnWidth',[150,80,150]));  
end
...
function plugin = HearingLossSimulation_v2025()
            WindowLength = 512;
